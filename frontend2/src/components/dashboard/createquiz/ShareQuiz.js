...
//instead of these we need to pass here domain name. but in a production environment, you would replace this with the actual domain name of your app (e.g., https://myquizapp.com).
